...
router.get('/scraper', (req,res) =>  {
  request('https://blog.ted.com/', (error, response, html) =>  { 
...
router.post("/articles/:id", function(req, res) {
  Note.create(req.body)
    .then(comment => Article.findOneAndUpdate({ _id: req.params.id }, { $push: { Note: comment }}, { new: true }))
